...
El backend Go queda como API operativa. Django sigue gestionando autenticacion, usuarios, permisos y administracion interna. Go recibira el JWT emitido por Django en las rutas `/api`.
